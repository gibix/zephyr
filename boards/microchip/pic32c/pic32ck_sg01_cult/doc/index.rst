.. zephyr:board:: pic32ck_sg01_cult

Overview
********

The PIC32CK SG01 Curiosity Ultra evaluation kit is a hardware platform
to evaluate the Microchip PIC32CK SG microcontrollers, and the
evaluation kit part number is EV44P93A. This kit provides a comprehensive
set of features that allow users to explore the PIC32CK SG peripherals
and gain insight into integrating the device into their own designs.

Hardware
********

- 144-pin TQFP PIC32CK2051SG01144 microcontroller
- Arm® Cortex®-M33 Microcontroller
- HSM with TrustZone® technology
...
- Programming and debugging of on-board PIC32CK SG through Serial Wire Debug (SWD) and on-board PKoB4 debugger
...
The `PIC32CK SG01 Curiosity Ultra User Guide`_ has detailed information about board connections.
...
3. Build the Application
   ...
   .. code-block:: console
      ...
      west build -b pic32ck_sg01_cult -p -s samples/basic/blinky

   This will build the Blinky application for the ``pic32ck_sg01_cult`` board.
...
.. code-block:: json

   {
      ...
      "configurations": [
         {
               "name": "Debug (J-Link, PIC32CK2051SG01144)",
               "type": "cortex-debug",
               "request": "launch",
               "servertype": "jlink",
               "device": "PIC32CK2051SG01144",
               "interface": "swd",
...
PIC32CK SG Product Page:
   https://www.microchip.com/en-us/product/pic32ck2051sg01144
...
.. _PIC32CK SG01 Curiosity Ultra evaluation kit Page:
   https://www.microchip.com/en-us/development-tool/EV44P93A

.. _PIC32CK SG01 Curiosity Ultra User Guide:
